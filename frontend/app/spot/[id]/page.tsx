              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <h2 className="text-heading font-bold text-card-foreground">
                      {spot?.name}
                    </h2>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center justify-between">
                  <h3 className="text-subheading font-bold text-card-foreground">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="text-body font-medium">
                        {spot?.verificationVotes.up}
                      </span>
                    </div>
                    <div className="flex items-center space-x-1">
                      <ThumbsDown className="h-4 w-4 text-red-600" />
                      <span className="text-body font-medium">
                        {spot?.verificationVotes.down}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="text-caption text-muted-foreground">
                  <p>
                    Submitted by {spot?.submittedBy} on{" "}
                    {new Date(
                      spot?.submittedDate ?? new Date()
                    ).toLocaleDateString()}
                  </p>
                </div>
